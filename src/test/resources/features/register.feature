Feature: Register feature
  ...
  Scenario: User should create account successfully
    ...
    And I enter first name "Beena"
    And I enter last name "Rani"
    And I select day
    And I select month
    And I select Year
    And I enter emailId "beenar@gmail.com"
    And I enter password "beenar" in password field
    And I confirm password "beenar"
    And I click on register button
